  ...
  # Cumulocity Asset Viewer Widget[<img width="35" src="https://user-images.githubusercontent.com/67993842/97668428-f360cc80-1aa7-11eb-8801-da578bda4334.png"/>](https://github.com/SoftwareAG/cumulocity-asset-viewer-widget/releases/download/2.2.0/asset-viewer-runtime-widget-2.2.0.zip)
...
> ### ⚠️ This project is no longer under development. Please use [Cumulocity Asset Viewer Widget Plugin](https://github.com/SoftwareAG/cumulocity-asset-viewer-widget-plugin) for Application Builder >=2.x.x and Cumulocity >=1016.x.x⚠️
...
* This widget support runtime deployment. Download [Runtime Binary](https://github.com/SoftwareAG/cumulocity-asset-viewer-widget/releases/download/2.2.0/asset-viewer-runtime-widget-2.2.0.zip)  and follow runtime deployment instructions.
...
1. Open Your existing App Builder project and install external dependencies by executing below command or install it manually.
    ...
    ```
2. Grab the Asset Viewer widget **[Latest Release Binary](https://github.com/SoftwareAG/cumulocity-asset-viewer-widget/releases/download/2.2.0/gp-asset-viewer-2.2.0.tgz)**.
